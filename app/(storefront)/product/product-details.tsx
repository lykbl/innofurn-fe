...
const ProductDetails = () => {
  ...
  return (
    <div className="flex gap-4">
            ...
            <AccordionItem value="description">
              ...
              <AccordionContent className="p-2">
                <div>
                  ...
                  curl-resistant jute blend that adds style and safety anywhere
                  a small accent rug is needed. The Kettle Grove Jute Rug
                  measures 16.5x33 inches and features a classic half circle
                  shape and tight braids constructed with a durable jute blend.
                  The special blend relaxes faster and stays flat. The included
                  PVC mat makes sure your beautifully braided jute rug stays
                  exactly where it should. The unique shape makes this rug the
                  perfect fit for doorways and in front of kitchen sinks.
                  Features a blend of warm caramel, country black and dark crème
                  with primitive-style stars stenciled in black for a natural,
                  rustic look that complements a wide array of country farmhouse
                  decor. Features
                  <ol>
                    <li>
                    ...
                    <li>
                      ...
                      other fibers for a heavier rug that relaxes faster and
                      stays flat.
                    </li>
                    <li>
                      Warm, natural tones form the perfect accent piece for
                      modern primitive, classic country and rustic cabin decor.
                    </li>
                    <li>
                      Alternating braids of warm caramel and country black with
                      deep creme highlights are surrounded by a ring of
                      primitive-style stars stenciled black to add rustic,
                      durable style to any surface.
                    </li>
                    <li>
                      Spot clean with a damp cloth and a mild, clear detergent.
                    </li>
                    <li>
                      The Kettle Grove Collection by VHC captures the cozy,
                      rustic feel of modern primitive decor with country black,
                      warm khaki and dark crème designs in a mix of traditional
                      patterns. Primitive five-point stars and crow accent
                      pieces feel at home in traditional country homes and
                      backcountry cabins.
                    </li>
                    <li>
                      Due to the difference of monitor colors, some rug colors
                      may vary slightly. We try to represent all rug colors as
      ...
      <div className="sticky flex w-1/2 flex-col gap-2">
