...
export default function Footer() {
  return (
    <footer className="w-full bg-background py-16">
      <div className="mx-auto flex w-full max-w-screen-2xl flex-col gap-16 text-sm font-medium text-primary">
        <div className="flex w-full justify-between">
          <div className="mr-6 flex w-1/5 flex-col gap-8">
            ...
            <div className="flex flex-col gap-2">
              <p className="mb-4 text-base font-semibold">We support you</p>
              <p>
                You can do all by yourself or get help from us. Our services
          ...
          <div className="flex w-1/5 flex-col gap-4">
            <p className="font-semibold">Shop & plan</p>
          ...
          <div className="flex w-1/5 flex-col gap-4">
            <p className="font-semibold">About InnoFurn</p>
            <div className="mt-2 flex flex-col gap-4">
              <p>InnoFurn Family</p>
